...
export default function OrderPage() {
    ...
    // Also update handleAddPrintJob to ensure all required fields are present
    ...
    // const handleItemOrderSubmit = async () => {
    //     try {
    //         setIsSubmitting(true)
    //         setErrorMessage('')

    //         if (!itemOrder.itemId || itemOrder.quantity < 1) {
    ...
    //         // Add item order data
    //         formData.append('items[0][product_id]', itemOrder.itemId)
    //         formData.append('items[0][quantity]', itemOrder.quantity)

    //         await submitOrder(formData)
    //         setItemOrder({ itemId: '', quantity: 1 })
    //         setSuccessMessage('Item order submitted successfully')
    //     } catch (error) {
    //         setErrorMessage(error.response?.data?.message || error.message)
    //     } finally {
    //         setIsSubmitting(false)
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <TextField
                                            ...
                                            name="numberOfPages"
                                            value={printJobOrder.numberOfPages}
                                            onChange={handleInputChange(
                                                setPrintJobOrder,
                                            )}
                                            InputProps={{
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <TextField
                                            ...
                                            name="numberOfCopies"
                                            value={printJobOrder.numberOfCopies}
                                            onChange={handleInputChange(
                                                setPrintJobOrder,
                                            )}
                                            InputProps={{
